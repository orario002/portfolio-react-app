...
export const SiteBuilderData = {
    banner: {
        name: 'Hero Banner',
        title: 'A microsite builder prototype offering B2B solution with SiteBuilder Experience Manager, to create simple webpages effortlessly.',
        intro: 'Designed for our partner to demonstrate how businesses can utilise SiteBuilder Experience Manager’s smart technology to quickly build microsites. Without technical knowledge, anyone from organisation can simply fill out a form to generate basic webpages using default templates.',
        img: `${Banner}`
    },
    summary: {
